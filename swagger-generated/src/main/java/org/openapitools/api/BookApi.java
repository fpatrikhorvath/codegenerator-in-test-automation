...
public interface BookApi {
     ...
     *         or Internal error (status code 500)
     */
    ResponseEntity<GenericErrorResponse> createBookForUserNeg(
            @PathVariable("userId") Long userId
            , @RequestBody CreateBookForUserRequestDTO createBookForUserRequestDTO
    );
     ...
     * @return Book deleted successfully (status code 204)
     */
    ResponseEntity<GenericErrorResponse> deleteBookForUserNeg(
            @PathVariable("userId") Long userId
            , @PathVariable("bookId") Long bookId
    );
     ...
     * @return List of books for the user (status code 200)
     */
    ResponseEntity<GenericErrorResponse> getBooksForUserNeg(
            @PathVariable("userId") Long userId
    );
